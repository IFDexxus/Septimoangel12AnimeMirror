...
function c511001299.initial_effect(c)
	...
	e2:SetTarget(c511001299.target)
	e2:SetOperation(c511001299.activate)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
...
function c511001299.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c511001299.cfilter,tp,LOCATION_ONFIELD,0,1,nil)
end
...
function c511001299.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	while tc do
		...
		tc:RegisterFlagEffect(511001299,RESET_EVENT+0x1fe0000,0,0)
		tc=g:GetNext()
	end
