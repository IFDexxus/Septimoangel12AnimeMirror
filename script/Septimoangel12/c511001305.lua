...
function c511001305.actcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c511001305.scfilter,tp,LOCATION_ONFIELD,0,1,nil,29762407)
end
function c511001305.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c511001305.scfilter,tp,LOCATION_ONFIELD,0,1,nil,511001306)
		and Duel.IsExistingMatchingCard(c511001305.scfilter,tp,LOCATION_ONFIELD,0,1,nil,29762407)
end
function c511001305.gfilter(c)
	return c:IsFaceup() and c:IsCode(511001306)
end
function c511001305.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsAbleToGraveAsCost() and Duel.IsExistingMatchingCard(c511001305.scfilter,tp,LOCATION_ONFIELD,0,1,nil,29762407)
		and Duel.IsExistingMatchingCard(c511001305.gfilter,tp,LOCATION_ONFIELD,0,1,c) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c511001305.gfilter,tp,LOCATION_ONFIELD,0,1,1,c)
	g:AddCard(c)
