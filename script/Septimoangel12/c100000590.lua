...
function c100000590.initial_effect(c)
	...
	e3:SetCondition(c100000590.setcon)
...
function c100000590.setcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c100000590.setfilter,tp,LOCATION_ONFIELD,0,1,nil)
end
