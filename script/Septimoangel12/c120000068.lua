...
function c120000068.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(120000068,0))
...
function c120000068.cfilter(c,e,tp)
	local val=0
...
function c120000068.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return eg:IsExists(c120000068.cfilter,1,nil,e,tp) end
	if eg:GetCount()==1 then
		Duel.SetTargetCard(eg)
	else
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
		local g=eg:FilterSelect(tp,c120000068.cfilter,1,1,nil,e,tp)
